                ...
                <div class="project <?php echo strtolower($project->uid()) ?>">
                    <ul class="project-items cf">
                        <?php foreach($project->media()->limit(9)->toStructure() as $media): ?>
                            ...
                            <li>
                                <a href="<?php echo e($mediaType == 'video', $media->video(), $original->url()) ?>" data-zoomable data-width="<?php echo $original->width() ?>" data-height="<?php echo $original->height() ?>"<?php if ($mediaType == 'video') : ?> data-type="video"<?php endif ?>>
