...
gulp.task("deploy", function (done) {
  runSequence("css:prod", "webpack:prod", "rev-assets", done);
});
...
//   exec(
//     's3cmd sync ./thumbs/ s3://olleenqvist.se/thumbs/ --acl-public --add-header="Cache-Control:max-age=315360000, no-transform, public"',
...
//   exec(
//     's3cmd sync ./content/ s3://olleenqvist.se/content/ --acl-public --add-header="Cache-Control:max-age=315360000, no-transform, public"',
//     function (err, stdout, stderr) {
//       console.log(stdout);
//       console.log(stderr);
//       cb(err);
